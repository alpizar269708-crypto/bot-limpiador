...
async function startBot() {
    ...
    // Obtenemos la versión oficial compatible para evitar el error 405
    ...
    sock.ev.on('connection.update', (update) => {
        ...
        if (connection === 'open') {
            ...
            if (reason !== DisconnectReason.loggedOut) {
                setTimeout(startBot, 3000); // Reintenta reconectar en 3 segundos
            } else {
                console.log('Sesión cerrada. Borra auth_info_baileys si deseas reescanear.');
            }
        }
    });
